...
void addElement(struct Node** head, int id,  char* name, float price) {
...
void removeElementById(struct Node** head, int id) {
  // dereferencing and assigning current pointer to head pointer
  struct Node* current = *head;
...
void updateElementById(struct Node* head, int id,  char* name, float price) {
  struct Node* current = head;
  while (current != NULL) {
    if (current->id == id) {
...
void printMatchingElements(struct Node* head,  char* name) {
  struct Node* current = head;
  while (current != NULL) {
